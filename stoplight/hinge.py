...
class Game(DirectObject):
  #make stoplight fling open when it it is red
  ...
  def setup(self):
    ...
    # Box B
    shape = BulletBoxShape(Vec3(10, 10, 0))
    ...
    visNP = loader.loadModel('models/stoplight.egg')
    visNP.clearModelNodes()
    visNP.reparentTo(bodyNP)
    ...
    hinge = BulletHingeConstraint(bodyB, pivotB, axisB, True)
    hinge.setDebugDrawSize(2.0)
    hinge.setLimit(0, 100, softness=0.9, bias=0.3, relaxation=00)
    self.world.attachConstraint(hinge)
